...
class FuncoesSeeder extends Seeder
{
    public function run(): void
    {
        $funcoes = [
            ...
            // 15. Auditor & Gestor de Contatos IA
            [
        ...
        // 5. Agente Auditor & Gestor de Contatos IA (Atlas)
        $atlas = User::where('email', 'atlas.contatos@leadcerto.com')->first();
        ...
        if (!$atlas) {
            ...
            $atlas->update([
                ...
                'is_ia'            => true,
                'provedor_ia'      => 'openrouter',
                'openrouter_modelo'=> $atlas->openrouter_modelo ?: 'anthropic/claude-3.5-sonnet',
                'gemini_email'     => 'atlas.contatos@leadcerto.com',
                'gemini_instrucoes'=> $atlasInstrucoes,
                'base_conhecimento'=> $atlasBase,
                'ativo'            => true,
        ...
        if (isset($cargosCriados['Auditor & Gestor de Contatos IA'])) {
            $atlas->cargos()->syncWithoutDetaching([$cargosCriados['Auditor & Gestor de Contatos IA']->id]);
        }
    }
}
