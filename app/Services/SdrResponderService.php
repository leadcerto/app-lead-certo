...
class SdrResponderService
{
    ...
    private function montarHistorico(SdrPersona $persona, TicketAtendimento $ticket, bool $origemLigacao = false, ?string $gatilho = null, ?string $orientacaoHumana = null): array
    {
        ...
        $contextoGatilho = match ($gatilho) {
            ...
            'janela_meta_6h' => "[GATILHO: JANELA META EXPIRANDO (< 6h) — A janela oficial de 24h do WhatsApp está próxima de fechar (restam menos de 6h). Mande um follow-up matinal amigável, acolhedor e objetivo para reengajar o lead e garantir sua resposta antes do encerramento da janela. Pergunte se ele conseguiu analisar a proposta/informação anterior ou se tem alguma dúvida. Tom educado e prestativo. {$lembreteChecklist} NÃO use [ENCERRADO] neste estágio.]",
