...
<div class="w-full max-w-sm">
    <div class="text-center mb-8">
        <h1 class="text-2xl font-bold text-white tracking-tight">Lead Certo</h1>
            ...
            <div>
                ...
                <div class="relative flex items-center">
                    <input
                        ...
                        class="w-full bg-gray-800 border border-gray-700 rounded-xl px-3.5 py-2.5 text-white text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 pr-11"
                        placeholder="••••••••"
                    >
                    <button type="button" id="btnTogglePass" onclick="toggleSenha()" class="absolute right-2.5 top-1/2 -translate-y-1/2 p-1.5 text-gray-400 hover:text-green-400 focus:outline-none transition rounded-lg hover:bg-gray-800">
                        {{-- Olho Aberto (quando senha está oculta) --}}
                        <svg id="iconOlhoAberto" class="w-5 h-5 block" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                        </svg>
                        {{-- Olho Fechado (quando senha está visível) --}}
                        <svg id="iconOlhoFechado" class="w-5 h-5 hidden text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
function toggleSenha() {
    ...
    const eyeOpen = document.getElementById('iconOlhoAberto');
    const eyeClosed = document.getElementById('iconOlhoFechado');
