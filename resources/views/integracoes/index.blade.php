            ...
            @else
                ...
                @if(config('services.meta.app_id'))
                    <a href="{{ route('meta.autorizar') }}"
                       class="flex items-center justify-center gap-3 w-full py-2.5 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium text-sm transition-all shadow-sm">
