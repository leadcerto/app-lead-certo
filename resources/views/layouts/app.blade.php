...
<div class="flex h-screen overflow-hidden">
    ...
    <aside class="w-56 bg-gray-900 text-white flex flex-col flex-shrink-0">
        ...
        <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
            ...
            @endphp
            <div x-data="{ aberto: {{ $gmbAtivo ? 'true' : 'false' }} }">
                <button @click="aberto = !aberto"
                        class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm w-full {{ $gmbAtivo ? 'bg-green-600 text-white' : 'text-gray-300 hover:bg-gray-700' }}">
                    <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {{-- Falar com o agente (Adriana, suporte da Lead Certo) — pedido
                 do Leonardo 2026-08-20, qualquer usuário logado vê --}}
            <a href="{{ route('equipe.conversar', 6) }}"
               class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm {{ request()->routeIs('equipe.conversar*') ? 'bg-green-600 text-white' : 'text-gray-300 hover:bg-gray-700' }}">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/>
                </svg>
                Falar com a Lead Certo
            </a>
